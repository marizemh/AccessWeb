			...
			<div class="py-8">
				...
				<ng-container *ngIf="overview.options[overview.selectedOption] as selectedOption">
					<div>
						<!-- Preview -->
						<div
							class="z-20 relative mt-10 h-192 ring-1 ring-gray-300 rounded-2xl shadow-xl overflow-auto dark:ring-gray-700"
						>
							<div class="flex flex-auto min-h-full">
								<!-- Navigation -->
								<div
									class="hidden md:block sticky top-0 flex-0 w-56 h-192 border-r border-gray-300 bg-gray-200 dark:border-gray-700 dark:bg-gray-800"
								>
									<div class="h-4"></div>
								...
								<div class="flex flex-col flex-auto">
									...
									<!-- Main -->
									<div id="component-container" class="relative flex flex-col flex-auto">
										<ng-container *ngComponentOutlet="selectedOption.component"></ng-container>
									</div>
									<!-- Footer -->
									<div
										class="relative z-10 flex items-center h-14 px-6 sm:px-10 border-t border-gray-300 bg-gray-200 dark:border-gray-700 dark:bg-gray-800"
									>
